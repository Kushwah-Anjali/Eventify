  ...
  {currentEvents.length === 0 ? (
    ...
    currentEvents.map((event, idx) => (
      <tr
        ...
        title="Double click to view registrations"
      >
        ...
        {visibleColumns.description && (
          <td className="desc-cell" title={event.description}>
            {event.description || "-"}
          </td>
        )}
        ...
        {visibleColumns.author && (
          <td title={event.author}>{event.author || "-"}</td>
        )}
        ...
        {visibleColumns.required_documents && (
          <td title={Array.isArray(event.required_documents)
        ...
        {visibleColumns.contact && (
          <td title={event.contact}>{event.contact || "-"}</td>
        )}
