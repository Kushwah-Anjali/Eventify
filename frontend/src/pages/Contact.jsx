            ...
            >
              <div>
                ...
                <div className="mb-3">
                  ...
                  <p className="opacity-75 mb-0">St. John's College, Agra</p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <p className="opacity-75 mb-0">+91 6398596448</p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <p className="opacity-75 mb-0">anjalikushwah8163@gmail.com</p>
                </div>
              </div>
